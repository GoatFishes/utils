...
const setVars = async (params) => {
    try {
        ...
        return { avgTimePerOrder, averageReturn, overallPerformance, numberOfOrders, sharpeRatio, longestOrder, shortestOrder, bestOrder, worstOrder}
    } catch (e) { 
        throw new ExceptionHandler(RESPONSE_CODES.APPLICATION_ERROR, `Fatal error backtest stats calculations : ${e}`) }
}
